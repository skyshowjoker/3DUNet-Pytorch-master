...
parser.add_argument('--dataset_path',default = r'C:\joey\git_program\3DUNet-Pytorch-master/dataset/fixed_lits',help='fixed trainset root path')
parser.add_argument('--test_data_path',default = r'C:\joey\git_program\3DUNet-Pytorch-master/dataset/Lits/test',help='Testset path')
