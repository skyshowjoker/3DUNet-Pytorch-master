    ...
    def fix_data(self):
        ...
        for ct_file,i in zip(file_list,range(Numbers)):
            ...
            if new_ct != None and new_seg != None:
                ...
                sitk.WriteImage(new_seg, os.path.join(self.fixed_path, 'label', ct_file.replace('volume', 'segmentation').replace('.nii.gz', '.nii.gz')))
...
if __name__ == '__main__':
    raw_dataset_path = r'C:\joey\git_program\3DUNet-Pytorch-master\dataset\Lits\train'
    fixed_dataset_path = r'C:\joey\git_program\3DUNet-Pytorch-master\dataset\fixed_lits'
